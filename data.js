...
const translations = {
    ...
    en: {
        ...
        rollTipInner: 'Inner diameter',
        rollTipInnerText: 'diameter of the core opening (cardboard core)',
        rollTipOuter: 'Outer diameter',
        rollTipOuterText: 'overall diameter of the roll with the edge band wound around it',
        rollTipEdging: 'Edging type',
        rollTipEdgingText: 'affects the winding density of the edge band',
        rollTipNote: 'the calculation is approximate; taking some extra tape is recommended',
